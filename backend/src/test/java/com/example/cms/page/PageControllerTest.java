...
class PageControllerTest {
    ...
    class GetPageTestClass {
        ...
        class VisiblePageTestClass {
            ...
            @Test
            void get_UserRole_WithUniversityAccessAndNotPageCreator_DetailsVisible()
                    throws Exception {
                ctx.setAuthentication(
                        CustomAuthenticationToken.create(
                                Role.USER, Set.of(universityId), userId + 1));
    ...
    class GetPagesTestClass {
        ...
        class GetPagesModeratorRoleTestClass {
            ...
            void getAll_ModeratorRole_WithUniversityAccess_Success_OnlyForAssignedUniversity()
                ...
                assertThat(
                        items,
                        everyItem(hasProperty("university", hasProperty("id", is(universityId)))));
            }

            @Test
            void getAll_ModeratorRole_WithUniversityAccess_FilterOnlyVisible_Success()
                    throws Exception {
                ctx.setAuthentication(
                        CustomAuthenticationToken.create(Role.MODERATOR, Set.of(universityId)));
        ...
        class GetPagesUserRoleTestClass {
            ...
            void getAll_UserRole_WithUniversityAccess_Success_OnlyForAssignedUniversity()
                    throws Exception {
                ctx.setAuthentication(
                        CustomAuthenticationToken.create(Role.USER, Set.of(universityId)));
