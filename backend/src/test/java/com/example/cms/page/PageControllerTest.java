...
class PageControllerTest {
    ...
    class GetPageTestClass {
        ...
        class VisiblePageTestClass {
            ...
            void get_GuestUser_DetailsHidden() throws Exception {
                ...
                var result = mvc.perform(get("/api/pages/" + pageId).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
        ...
        class NotVisiblePageTestClass {
            ...
            void get_GuestUser_Forbidden() throws Exception {
                ctx.setAuthentication(new TestingAuthenticationToken(null, null));
                mvc.perform(get("/api/pages/" + pageId).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andReturn();
            }
            ...
            void get_AdminRole_Success() throws Exception {
                ...
                mvc.perform(get("/api/pages/" + pageId).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
            }
    ...
    class GetPagesTestClass {
        ...
        void getAll_GuestUser_Forbidden() throws Exception {
            ctx.setAuthentication(new TestingAuthenticationToken(null, null));
            mvc.perform(get("/api/pages").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isUnauthorized()).andReturn();
        }
        ...
        class GetPagesAdminRoleTestClass {
            ...
            void getAll_AdminRole_Success() throws Exception {
                ...
                mvc.perform(get("/api/pages").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
            }
            ...
            void getAll_AdminRole_FilterOnlyVisible_Success() throws Exception {
                ...
                var result = mvc.perform(get("/api/pages?hidden_eq=false").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
            ...
            void getAll_AdminRole_FilterOnlyHidden_Success() throws Exception {
                ...
                var result = mvc.perform(get("/api/pages?hidden_eq=true").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
        ...
        class GetPagesModeratorRoleTestClass {
            ...
            void getAll_ModeratorRole_WithUniversityAccess_Success_OnlyForAssignedUniversity() throws Exception {
                ...
                var result = mvc.perform(get("/api/pages").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
    ...
    class UpdatePageTestClass {
        ...
        class UpdateUniversityMainPageTestClass {
            public PageDtoFormUpdate getUpdateForm() {
                ...
                return new PageDtoFormUpdate(page.getTitle(), page.getDescription(), "TEST_UPDATED_CONTENT", page.isHidden(), page.getHandlers().stream().map(User::getId).collect(Collectors.toSet()), page.getCreator().getId());
            }
            ...
            public void update_UniversityUser_Forbidden() throws Exception {
                ...
                mvc.perform(put("/api/pages/" + pageId).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(getUpdateForm()))).andExpect(status().isForbidden());
            }
            ...
            public void update_UniversityAdministrator_Success() throws Exception {
                ...
                mvc.perform(put("/api/pages/" + pageId).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(getUpdateForm()))).andExpect(status().isNoContent());
            }
