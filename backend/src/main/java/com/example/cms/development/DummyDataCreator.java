...
class DummyDataCreator implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private enum DatabaseSchemaCreateType {
        INITIALIZE, // create only main admin so the data can be added manually (e.g., using a
            ...
            if (applicationConfigurationProvider
                ...
                if (applicationConfigurationProvider
                    ...
                    throw new WrongParameterException(
                            "Invalid value of parameter databaseSchemaCreateType.");
                }
            } else {
     ...
     * BackupService#getRestoreMainPath()}, and if so, then takes randomly one of available zip
     * files and tries to restore all tables in the database from that backup file. If there is not
     * a zip file in the path returned by {@link BackupService#getRestoreMainPath()}, then inserts
     * data into the database based on the value of the parameter.
     *
                        ...
                        () -> {
                            switch (databaseSchemaCreateType) {
                                ...
                                case INITIALIZE:
                                    createInitialData();
                                    log.info(
                                            "** Database schema initialized with a main administrator account.");
                                    break;
                            }
                        });
    }
     ...
     * manually in a browser (users, universities, user enrollments, pages, keywords, and a
     * template).
     */
    private void createDummyData() {
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 5L, 2L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Students", "News, education, work, sport...", "", 5L, 2L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 19L, 2L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 19L, 2L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 20L, 2L, "", false));
        pageService.save(
                new PageDtoFormCreate("News", "News for our students.", "", 5L, 22L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Academic Calendar",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 6L, 3L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 21L, 3L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 21L, 3L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 22L, 3L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 7L, 4L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 23L, 4L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 23L, 4L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 24L, 4L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 8L, 5L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 25L, 5L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 25L, 5L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 26L, 5L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 9L, 6L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 27L, 6L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 27L, 6L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 28L, 6L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 10L, 7L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 29L, 7L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 29L, 7L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 30L, 7L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 11L, 8L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 31L, 8L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 31L, 8L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 32L, 8L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 12L, 9L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
                        ...
                        false));
        pageService.save(
                new PageDtoFormCreate("Business", "Services and experts", "", 33L, 9L, "", false));
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 33L, 9L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        pageService.save(
                new PageDtoFormCreate(
                        "History", "The history of our university.", "", 34L, 9L, "", false));

        pageService.save(
                new PageDtoFormCreate(
                        "Education", "The list of courses we offer.", "", 13L, 10L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Research",
                        "The list of research papers and other academic studies.",
        ...
        pageService.save(
                new PageDtoFormCreate("Staff", "The list of our staff.", "", 35L, 10L, "", false));
        pageService.save(
                new PageDtoFormCreate(
                        "Contact",
                        "This page contains contact information.",
        ...
        templateService.save(
                new TemplateDtoFormCreate(
                        "UniversityTemplate",
                        "Template used for university main page",
                        Set.of(),
                        true));
