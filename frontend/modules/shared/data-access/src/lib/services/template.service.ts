...
export class TemplateService {
  ...
  getTemplate(id: number): Observable<Template> {
    return this.http
      .get<Template>(`${this.templateUrl}/${id}`);
  }

  getAllTemplates(): Observable<Template[]> {
    return this.http
      .get<Template[]>(this.templateUrl + "/all");
  }
  ...
  addTemplate(name: string): Observable<Template> {
    return this.http
      .post<Template>(this.templateUrl, name);
  }
  ...
  modifyTemplateNameField(
    ...
    return this.http
      .patch<void>(`${this.templateUrl}/${id}/name`, name);
  }
  ...
  deleteTemplate(id: number): Observable<any> {
    return this.http
      .delete<void>(`${this.templateUrl}/${id}`);
  }
}
